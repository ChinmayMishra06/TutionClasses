...
<div class="register-box">
  ...
  <div class="register-box-body">
    <p class="login-box-msg">Sign up a new membership</p>
      ...
      <?php } ?>
    <form action="<?php echo base_url(); ?>institute/signUp" method="post" id="signUpForm">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="username" placeholder="Full name" value="<?php echo set_value('username'); ?>">
      ...
      <div class="form-group has-feedback">
        ...
        <?php if(validation_errors()) echo form_error('confirm_password'); ?>
      </div>
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox" id="T&C"> I agree to the <a href="#">terms</a>
            </label>
          </div>
        </div>
        <!-- /.col -->
