            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single_member_counter">
                        <span class="counter"><?php echo ($allTeachers != false) ? $allTeachers : 0; ?></span>
                        <h4>Teachers/Institutes</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_member_counter">
                        <span class="counter"><?php echo ($allStudents != false) ? $allStudents : 0; ?></span>
                        <h4>Students</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_member_counter">
                        <span class="counter"><?php echo ($allCourses != false) ? $allCourses : 0; ?></span>
                        <h4>Courses</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_member_counter">
                        <span class="counter"><?php echo  ($allSubscribers != false) ? $allSubscribers : 0; ?></span>
                        <h4>Subscribers</h4>
                    </div>
                </div>
            </div>
